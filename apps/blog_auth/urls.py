...
from apps.blog_auth.views import SignUpView
...
urlpatterns = [
    ...
    path('registercomplete', TemplateView.as_view(template_name='blog_auth/registercomplete.html'), name='registercomplete'),
